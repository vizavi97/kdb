        ...
        <div class="container">
            ...
            <div class="row extra py-4">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="<?php echo e(route('press-center.copy-right', app()->getLocale())); ?>" class="pr-4">
                        <?php echo app('translator')->get('layouts/footer.terms-of'); ?>
                    </a>
		    <a href="http://thefarhod.uz/" target="_blank">
                        <?php echo app('translator')->get('layouts/footer.dev'); ?>
                    </a>
                </div>
            </div>
        </div>
...
<!-- Footer Ends --><?php /**PATH C:\Users\farkh\OneDrive\Desktop\FARHOD\KDB\resources\views/layouts/footer.blade.php ENDPATH**/ ?>