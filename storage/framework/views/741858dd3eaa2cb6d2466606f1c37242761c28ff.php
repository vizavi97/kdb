                        ...
                        <div class="col-lg-6 item-parent">
                            <div class="item">
                                <div class="row align-items-center no-gutters">
                                    ...
                                    <div class="col-md-10">
                                        <a href="mailto:natasha.lebedeva@kdb.uz" class="blue-link">
                                            natasha.lebedeva@kdb.uz
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 item-parent">
                            <div class="item">
                                <div class="row align-items-center no-gutters">
                                    ...
                                    <div class="col-md-10">
                                        <a href="mailto:shahobiddin.salahitdinov@kdb.uz" class="blue-link">
                                            shahobiddin.salahitdinov@kdb.uz
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 item-parent">
                            <div class="item">
                                <div class="row align-items-center no-gutters">
                                    ...
                                    <div class="col-md-10">
                                        <a href="tel:shahob(+998) 78 120-80-00 (int.880, 881)" class="blue-link">
                                            (+998 78) 120-80-00 (880,881)
                                        </a>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Teacher\Desktop\KDBBU\resources\views/press-center/procurement.blade.php ENDPATH**/ ?>