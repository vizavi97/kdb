    ...
    <section class="desctop container deposits mt-5">
        <div class="row">
            ...
            <main class="col-xl-9 main-hero mb-5">
                ...
                <button><?php echo app('translator')->get('individuals/deposits.18'); ?></button>
            </main>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DESKTOP\KDB\resources\views/individuals/deposits.blade.php ENDPATH**/ ?>