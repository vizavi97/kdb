<aside class="col-xl-3 aside-hero">
    ...
    <ul>
        ...
        <li>
            <a href="<?php echo e(Request::is( app()->getLocale() . '/interactive-services/usefull-links') ? 'javascript:void(0)' : route('interactive-services.usefull-links', app()->getLocale())); ?>" class="<?php echo e(Request::is( app()->getLocale() . '/interactive-services/usefull-links') ? 'active' : ''); ?>">Usefull Links</a>
        </li>
    </ul>
</aside><?php /**PATH C:\Users\Teacher\Desktop\KDBLIVE\resources\views/layouts/sidebars/interactive-services-sidebar.blade.php ENDPATH**/ ?>