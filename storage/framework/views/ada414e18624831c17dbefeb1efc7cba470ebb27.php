    ...
    <section class="desctop container trade-finance">
        <div class="row">
            ...
            <main class="col-xl-9 main-hero mb-5">
                ...
                <p class="small-paragraph">
                    The main tasks of Trade Finance Department of the Bank is to provide high quality, timely and efficient trade finance services to corporate customers. Trade Finance Team operates strongly in accordance with a range of legislative and normative documents of The Republic of Uzbekistan and with international rules such as Uniform Customs and Practice for Documentary Credits (ICC publication number 600, edition 2007), Uniform Rules on Safeguards of the International Chamber of Commerce, INCOTERMS 2010.
                </p>
                ...
                <div class="letters-credit">
                    ...
                    <ul class="right-icon mt-4">
                        <li>
                            <p>
                                Application for opening letter of credit, filled by a client (form #1);
                            </p>
                        </li>
                        <li>
                            <p>
                                Copy of import contract concluded between the client and its foreign partner (as an applicant and beneficiary);
                            </p>
                        </li>
                        <li>
                            <p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Teacher\Desktop\KDB Last\resources\views/corporates/trade-finance.blade.php ENDPATH**/ ?>