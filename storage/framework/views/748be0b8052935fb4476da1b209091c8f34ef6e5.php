    ...
    <header class="header-index">
        <div class="slider-index">
            ...
            <div class="slider__slides">
                    ...
                    <div class="slide-index s--active">
                        <div class="slide__inner">
                            <div class="header-slider">
                                <img src="https://kdb.uz/storage/slides/February2020/o29mHxyNAd44Rbbjdb9V.jpg" alt="Loans for sustainable business">
                                <div class="slider-caption">
                                    <div class="position-relative w-100 h-100">
                                        <div class="slider-caption-inner">
                                            <h1 class="heading-1">Кредиты для устойчивого бизнеса</h1>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <a href="//kdb.uz/ru/corporates/credit" class="readmore-button">ПОДРОБНЕЕ </a>
                                                </div>
                    ...
                    <div class="slide-index">
                        <div class="slide__inner">
                            <div class="header-slider">
                                <img src="https://kdb.uz/storage/slides/February2020/ThMx4L8QGOpHdFPvRXg5.jpg" alt="Trade Finance for Global Business">
                                <div class="slider-caption">
                                    <div class="position-relative w-100 h-100">
                                        <div class="slider-caption-inner">
                                            <h1 class="heading-1">Торговое финансирование для глобального бизнеса</h1>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <a href="//kdb.uz/ru/corporates/trade-finance" class="readmore-button">ПОДРОБНЕЕ </a>
                                                </div>
                                                <div class="col-md-6 d-none d-md-flex justify-content-end">
                                                    <svg class="slider__control mainPrevBtn" xmlns="//www.w3.org/2000/svg" width="7.41" height="12" viewBox="0 0 7.41 12">
                                                        <path d="M15.41,7.41,14,6,8,12l6,6,1.41-1.41L10.83,12Z" transform="translate(-8 -6)" fill="#fff"></path>
                    ...
                    <div class="slide-index">
                        <div class="slide__inner">
                            <div class="header-slider">
                                <img src="https://kdb.uz/storage/slides/March2020/KeSk0JmXdZuq3lzOHrH8.jpg" alt="trustable International premium cards">
                                <div class="slider-caption">
                                    <div class="position-relative w-100 h-100">
                                        <div class="slider-caption-inner">
                                            <h1 class="heading-1">Надежные международные карты</h1>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <a href="//kdb.uz/ru/individuals/international-cards" class="readmore-button">ПОДРОБНЕЕ </a>
                                                </div>
                                                <div class="col-md-6 d-none d-md-flex justify-content-end">
                                                    <svg class="slider__control mainPrevBtn" xmlns="//www.w3.org/2000/svg" width="7.41" height="12" viewBox="0 0 7.41 12">
                                                        <path d="M15.41,7.41,14,6,8,12l6,6,1.41-1.41L10.83,12Z" transform="translate(-8 -6)" fill="#fff"></path>
                    ...
                    <div class="slide-index s--prev">
                        <div class="slide__inner">
                            <div class="header-slider">
                                <img src="https://kdb.uz/storage/slides/March2020/WiSxl2iZvSVoqtVWcn5Q.jpg" alt="Flexible solutions for corporates">
                                <div class="slider-caption">
                                    <div class="position-relative w-100 h-100">
                                        <div class="slider-caption-inner">
                                            <h1 class="heading-1">Гибкие решения для клиентов</h1>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <a href="//kdb.uz/ru/corporates/crm" class="readmore-button">ПОДРОБНЕЕ </a>
                                                </div>
                                                <div class="col-md-6 d-none d-md-flex justify-content-end">
                                                    <svg class="slider__control mainPrevBtn" xmlns="//www.w3.org/2000/svg" width="7.41" height="12" viewBox="0 0 7.41 12">
                                                        <path d="M15.41,7.41,14,6,8,12l6,6,1.41-1.41L10.83,12Z" transform="translate(-8 -6)" fill="#fff"></path>
                            ...
                            <div class="owl-carousel <?php echo e((count($announcements) > 2) ? 'owl-item-3' : 'owl-item-4'); ?>">
                                <?php $__currentLoopData = $announcements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $announcement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a class="news-item" href="<?php echo e(route('press-center.news', app()->getLocale()) . '/' . $announcement->slug); ?>">
                                        ...
                                        <div class="news-data">
                                            <span><?php echo e(date( 'd.m.Y', strtotime($announcement->created_at) )); ?></span>
                                        </div>
                                        <div class="news-caption">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/u0560543/kdb.itmaker.uz/resources/views/homepage.blade.php ENDPATH**/ ?>