                ...
                <div class="first-stuff">
                    ...
                    <div class="row">
                        <div class="col-lg-6 item">
                            <a href="#" class="mydiv">
                                <div class="image">
                                    <img src="<?php echo e(asset('img/corporates/accaunt-opening/1.jpg')); ?>">
                                </div>
                        ...
                        <div class="col-lg-6 item">
                            <a href="#" class="mydiv">
                                <div class="image">
                                    <img src="<?php echo e(asset('img/corporates/accaunt-opening/2.jpg')); ?>">
                                </div>
                                <h6 class="heading-black">
                                Internet Banking
                                </h6>
                        ...
                        <div class="col-lg-6 item">
                            <a href="#" class="mydiv">
                                <div class="image">
                                    <img src="<?php echo e(asset('img/corporates/accaunt-opening/3.jpg')); ?>">
                                </div>
                                <h6 class="heading-black">
                                Office.Net
                                </h6>
                        ...
                        <div class="col-lg-6 item">
                            <a href="#" class="mydiv">
                                <div class="image">
                                    <img src="<?php echo e(asset('img/corporates/accaunt-opening/4.jpg')); ?>">
                                </div>
                                <h6 class="heading-black">
                                SMS Informing
                                </h6>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DESKTOP\KDB\resources\views/corporates/account-opening.blade.php ENDPATH**/ ?>