                ...
                <div class="row transfer-service pb-48">
                    ...
                    <div class="col-md-6 service_video p-0">
                        <a data-fancybox  href="<?php echo e(asset('video/transfer.mp4')); ?>" class="fancybox">
                            <img class="img-cover" src="<?php echo e(asset('img/individuals/payments-and-transfers/player-background.png')); ?>" alt="Video player">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7 col-md-5 col-lg-4">
                            <div class="contact box-shadow">
                                <img src="<?php echo e(asset('img/individuals/payments-and-transfers/user-tie-solid.svg')); ?>" alt="user">
                                <span>
                                    <a href="tel:+998781208000" class="phone-number">(+998 78) 120-80-00</a>
                                </span>
                            </div>
                        </div>
                        <!--End Contact Info -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Teacher\Desktop\KDBLIVE\resources\views/individuals/payments-and-transfers.blade.php ENDPATH**/ ?>