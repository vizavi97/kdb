        ...
        <div class="row">
            ...
            <main class="col-xl-9 main-hero mb-5">
                ...
                <div class="row mt-4 pb-48">
                    <div class="col-lg-4">
                        <figure class="m-0">
                            <img class="w-100" src="<?php echo e(asset('img/corporates/trade-finance/Export and import Letters of credit.svg')); ?>" alt="Export and import Letters of credit">
                            <figcaption>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Teacher\Desktop\KDBLIVE\resources\views/corporates/trade-finance.blade.php ENDPATH**/ ?>