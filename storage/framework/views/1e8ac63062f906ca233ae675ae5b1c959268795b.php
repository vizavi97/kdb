<aside class="col-xl-3 aside-hero">
    ...
    <ul>
        ...
        <li>
            <a href="<?php echo e(Request::is( app()->getLocale() . '/press-center/copy-right') ? 'javascript:void(0)' : route('press-center.copy-right', app()->getLocale())); ?>" class="<?php echo e(Request::is( app()->getLocale() . '/press-center/copy-right') ? 'active' : ''); ?>">Copy Right</a>
        </li>
    </ul>
</aside><?php /**PATH C:\Users\Uzgenius Academy\Desktop\WEBSITES\KDB\resources\views/layouts/sidebars/press-center-sidebar.blade.php ENDPATH**/ ?>