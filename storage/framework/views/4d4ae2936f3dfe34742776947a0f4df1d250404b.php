        ...
        <div class="row">
            ...
            <main class="col-xl-9 main-hero">
                <div class="row conversion-card">
                    ...
                    <div class="col-12">
                        <p class="mt-4">
                            <?php echo app('translator')->get('individuals/exchange-office/currency-conversion.7'); ?>
                        </p>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DESKTOP\KDB\resources\views/individuals/exchange-office/currency-conversion.blade.php ENDPATH**/ ?>