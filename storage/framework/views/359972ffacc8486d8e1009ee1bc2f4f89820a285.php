...
<?php $__env->startSection('page-title'); ?>
    <?php echo app('translator')->get('individuals/bank-tariffs.1'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <span class="small-paragraph"><?php echo app('translator')->get('individuals/bank-tariffs.2'); ?></span>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('meta'); ?>

    <title><?php echo app('translator')->get('individuals/bank-tariffs.3'); ?></title>
                        ...
                        <div class="business-plan-box">
                            ...
                            <div class="p-4">
                                ...
                                <a href="<?php echo e(Voyager::image( (json_decode($tariff['file_' . app()->getLocale()]))[0]->download_link )); ?>" class="flex-justify-center" download>
                                   ...
                                   <span class="small-paragraph"><?php echo app('translator')->get('individuals/bank-tariffs.4'); ?></span>
                               </a>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/u0560543/kdb.itmaker.uz/resources/views/individuals/bank-tariffs.blade.php ENDPATH**/ ?>