                    ...
                    <div class="col-lg-8 p-0 pl-lg-5 mt-4 mt-lg-0">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <p class="small-paragraph fs-14 d-flex align-items-center mb-0">
                                    ...
                                    <strong class="pl-2"><?php echo e($card->payment_system->name); ?></strong>
                                </p>
                            </div>
                        ...
                        <div class="row mt-5">
                            <div class="col-md-4">
                                ...
                                <p class="small-paragraph fs-14 d-flex align-items-center mb-0">
                                    <strong class="pl-2"><?php echo e($card['validity']); ?></strong>
                                </p>
                            </div>
                            <div class="col-md-4 mt-4 mt-md-0">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Teacher\Desktop\KDBBU\resources\views/corporates/single-local-card.blade.php ENDPATH**/ ?>