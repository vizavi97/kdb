<?php $__env->startSection('page-title', 'Licenses & Certificates'); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <span class="small-paragraph">Licenses & Certificates</span>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('meta'); ?>

    <title>KDB | Licenses & Certificates</title>
                ...
                <div class="global-modal-window flex-center" id="<?php echo e($license->id); ?>">
                    <div class="global-modal-content">
                        ...
                        <div class="modal-content-inner">
                            ...
                            <div class="row px-4">
                                <div class="col-md-6">
                                    <h5 class="small-paragraph">License Number:</h5>
                                    <p class="small-paragraph"><?php echo e($license->license_number); ?></p>
                                </div>
                                <div class="col-md-6">
                                    <h5 class="small-paragraph">Issued Date:</h5>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Uzgenius Academy\Desktop\WEBSITES\KDB\resources\views/about-us/licenses-and-certificates.blade.php ENDPATH**/ ?>