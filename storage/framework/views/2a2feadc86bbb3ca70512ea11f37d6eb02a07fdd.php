            ...
            <main class="col-xl-9 main-hero">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <?php 
                        ...
                        $dotPos = strpos($currentRoute, '.');
                        $pageType = strtoupper( substr($currentRoute, $dotPos + 1, strpos($currentRoute, '-') - $dotPos - 1) );
                    ?>
                    <?php $__currentLoopData = $paymentSystems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paymentSystem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(count($paymentSystem->cards) > 0 && $paymentSystem->category == $pageType): ?>
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(($i == 1) ? 'active' : ''); ?>" 
                                    id="<?php echo e($paymentSystem->name); ?>-tab"
                                    data-toggle="tab"
                                    href="#<?php echo e($paymentSystem->name); ?>"
                                    role="tab"
                                    aria-controls="<?php echo e($paymentSystem->name); ?>"
                                    aria-selected="true">
                                        <?php echo e($paymentSystem->name); ?>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <?php $__currentLoopData = $paymentSystems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paymentSystem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(count($paymentSystem->cards) > 0 && $paymentSystem->category == $pageType): ?>
                            <div class="tab-pane fade <?php echo e(($a == 1) ? 'show active' : ''); ?>" id="<?php echo e($paymentSystem->name); ?>" role="tabpanel" aria-labelledby="<?php echo e($paymentSystem->name); ?>-tab">
                                <?php $__currentLoopData = $paymentSystem->cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(url('corporates/' . $pageSlug . '/' . $card->slug)); ?>" class="card-link">
                                                    ...
                                                    <div class="row mt-4">
                                                        <div class="col-md-4">
                                                            ...
                                                            <p class="small-paragraph fs-14 d-flex align-items-center mb-0">
                                                                ...
                                                                <strong class="pl-2"><?php echo e($paymentSystem->name); ?></strong>
                                                            </p>
                                                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Teacher\Desktop\KDBBU\resources\views/corporates/local-cards.blade.php ENDPATH**/ ?>