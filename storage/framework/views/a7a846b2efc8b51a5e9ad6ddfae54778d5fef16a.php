<aside class="col-xl-3 aside-hero">
    ...
    <ul>
        ...
        <li>
            <a href="<?php echo e(Request::is( app()->getLocale() . '/interactive-services/exchange-rates') ? 'javascript:void(0)' : route('interactive-services.exchange-rates', app()->getLocale())); ?>" class="<?php echo e(Request::is( app()->getLocale() . '/interactive-services/exchange-rates') ? 'active' : ''); ?>">Exchange Rates</a>
        </li>
        <li>
            <a href="<?php echo e(Request::is( app()->getLocale() . '/interactive-services/calculators') ? 'javascript:void(0)' : route('interactive-services.calculators', app()->getLocale())); ?>" class="<?php echo e(Request::is( app()->getLocale() . '/interactive-services/calculators') ? 'active' : ''); ?>">Calculators</a>
        </li>
        <li>
...
</aside><?php /**PATH C:\Users\User 5\Desktop\KDB Last\resources\views/layouts/sidebars/interactive-services-sidebar.blade.php ENDPATH**/ ?>