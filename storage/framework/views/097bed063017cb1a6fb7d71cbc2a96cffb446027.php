        ...
        <div class="row">
            ...
            <main class="col-xl-9 main-hero mb-5">
              <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $report): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if( count( json_decode($report->file)) ): ?>
                <div class="row download">
                    <div class="col-12">
                          <a class="row" href="<?php echo e(Voyager::image( (json_decode($report->file))[0]->download_link )); ?>" download>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Uzgenius Academy\Desktop\WEBSITES\KDB\resources\views/investors/audit-reports.blade.php ENDPATH**/ ?>