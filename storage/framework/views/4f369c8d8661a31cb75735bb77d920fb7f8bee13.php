            ...
            <main class="col-xl-9 main-hero mb-5 ">
                ...
                <div>
                    ...
                    <div class="opener-info" id="<?php echo e($award->id); ?>">
                        <div class="row">
                            <div class="col-md-6 p-4 order-2 order-md-1"><?php echo $award->getTranslatedAttribute('body', app()->getLocale(), 'fallbackLocale'); ?></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User 5\Desktop\KDB Last\resources\views/about-us/awards.blade.php ENDPATH**/ ?>