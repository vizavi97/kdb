                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="business-plan-box">
                            ...
                            <div class="p-4">
                                <h2 class="heading-3 mb-3"><?php echo e($plan->getTranslatedAttribute('name', app()->getLocale(), 'fallbackLocale') . ' ' . date( 'd.m.Y', strtotime($plan->created_at) )); ?></h2>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User 5\Desktop\KDB Last\resources\views/about-us/business-plan.blade.php ENDPATH**/ ?>