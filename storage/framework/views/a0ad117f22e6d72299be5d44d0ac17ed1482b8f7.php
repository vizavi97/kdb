<?php $__env->startSection('page-title', 'Bank\'s Charter'); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <span class="small-paragraph">Bank\'s Charter</span>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('meta'); ?>

    <title>KDB | Bank\'s Charter</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="business-plan-box">
                            ...
                            <div class="p-4">
                                <h2 class="heading-3 mb-3"><?php echo e($tariff->name . ' ' . date( 'd.m.Y', strtotime($tariff->created_at) )); ?></h2>
                                <a href="<?php echo e(Voyager::image( (json_decode($tariff->file))[0]->download_link )); ?>" class="flex-justify-center" download>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/uzgenius/domains/uzgenius.uz/public_html/kdb/resources/views/about-us/banks-charter.blade.php ENDPATH**/ ?>