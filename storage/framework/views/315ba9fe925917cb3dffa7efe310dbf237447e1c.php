<?php $__env->startSection('page-title', 'Banking Regulations'); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <span class="small-paragraph">Banking Regulations</span>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('meta'); ?>

    <title>KDB | Banking Regulations</title>
        ...
        <div class="row">
            ...
            <main class="col-xl-9 main-hero mb-5">
                <div class="first-parent">
                    ...
                    <?php if(count( json_decode($file->file)) > 0 ): ?>
                        <div class="row box">
                            <div class="col-sm-8">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Uzgenius Academy\Desktop\WEBSITES\KDB\resources\views/interactive-services/bank-regulations.blade.php ENDPATH**/ ?>