                                ...
                                <div>
                                    ...
                                    <div class="post-date">
                                        ...
                                        <?php elseif($locale == "en"): ?>
                                            <?php echo e(date('M d, Y g:i a', strtotime(  $post->date ))); ?>

                                        <?php else: ?>
                                            <?php echo e(date('M d, Y G:i', strtotime(  $post->date ))); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/uzgenius/domains/uzgenius.uz/public_html/kdb/resources/views/press-center/single-news.blade.php ENDPATH**/ ?>