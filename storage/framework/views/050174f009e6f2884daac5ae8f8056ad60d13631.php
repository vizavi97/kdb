                  ...
                  <div class="row no-gutters">
                    <div class="col-lg-6">
                      <div class="image-parent">
                        <img src="<?php echo e(asset('img/about-us/branches/1.1.png')); ?>" class="img-cover">
                      </div>
                    </div>
                    <div class="col-lg-6 space-1">
                      <h5 class="heading-black">
                      Head Office
                      </h5>
                      <h6 class="helper mb-1">
                      3, Bukharo Street, 100047
                      </h6>
                      <h6 class="helper">
                      Tashkent, Uzbekistan
                      </h6>
                      <h6 class="helper">
                      <span>Phone:</span> (+998 78) 120-80-00
                      </h6>
                      <h6 class="helper">
                      <span>E-mail:</span> info@kdb.uz
                      </h6>
                    </div>
                  </div>
                </div>
              ...
              <div class="row parent no-gutters">
                <div class="col-lg-6">
                  <div class="row no-gutters">
                    <div class="col-lg-6">
                      <div class="image-parent">
                        <img src="<?php echo e(asset('img/about-us/branches/1.2.png')); ?>" class="img-cover">
                      </div>
                    </div>
                    <div class="col-lg-6 space-1">
                      <h5 class="heading-black">
                      ...
                      <h6 class="helper mb-1">
                      77, Minor Street, 100084
                      </h6>
                      <h6 class="helper">
                      Tashkent, Uzbekistan
                      </h6>
                      <h6 class="helper">
                      <span>Phone:</span> (+998 78) 120-61-41
                      </h6>
                      <h6 class="helper">
                      <span>E-mail:</span> info@kdb.uz
                      </h6>
              ...
              <div class="row parent no-gutters">
                <div class="col-lg-6">
                  <div class="row no-gutters">
                    <div class="col-lg-6">
                      <div class="image-parent">
                        <img src="<?php echo e(asset('img/about-us/branches/1.3.png')); ?>" class="img-cover">
                      </div>
                    </div>
                    <div class="col-lg-6 space-1">
                      <h5 class="heading-black">
                      ...
                      <h6 class="helper mb-1">
                      12, Usmon Nosir Str., 100070
                      </h6>
                      <h6 class="helper">
                      Tashkent, Uzbekistan
                      </h6>
                      <h6 class="helper">
                      <span>Phone:</span> (+998 78) 140-06-30
                      </h6>
                      <h6 class="helper">
                      <span>E-mail:</span> info@kdb.uz
                      </h6>
              ...
              <div class="row parent no-gutters">
                <div class="col-lg-6">
                  <div class="row no-gutters">
                    <div class="col-lg-6">
                      <div class="image-parent">
                        <img src="<?php echo e(asset('img/about-us/branches/1.4.png')); ?>" class="img-cover">
                      </div>
                    </div>
                    <div class="col-lg-6 space-1">
                      <h5 class="heading-black" style="text-transform: initial;">
                      Center for Coordination of Investment Activities and Project Management
                      </h5>
                      <h6 class="helper mb-1">
                      32, Oybek Street, 100015
                      </h6>
                      <h6 class="helper">
                      Tashkent, Uzbekistan
                      </h6>
                      <h6 class="helper">
                      <span>Phone:</span> (+998 71) 252-78-65
                      </h6>
                      <h6 class="helper">
                      <span>E-mail:</span> fisc@kdb.uz
                      </h6>
                    </div>
                  </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Teacher\Desktop\KDBLIVE\resources\views/about-us/branches.blade.php ENDPATH**/ ?>