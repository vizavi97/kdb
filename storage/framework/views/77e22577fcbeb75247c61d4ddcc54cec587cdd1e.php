<?php $__env->startSection('page-title', 'Mobile Banking'); ?>
            ...
            <main class="col-xl-9 main-hero ">
                <div class="row">
                    ...
                    <div class="col-md-6 d-none d-md-block">
                        <img src="<?php echo e(asset('img/individuals/remote-banking/mobile-banking/phone.png')); ?>">
                    </div>
                </div>
                <div class="row mt-5 mx-0">
                    <div class="col-md-6 p-0">
                        <div class="mobile-banking-video align-right">
                            <a data-fancybox  href="<?php echo e(asset('video/transfer.mp4')); ?>" class="fancybox">
                                <img class="img-cover" src="<?php echo e(asset('img/individuals/remote-banking/mobile-banking/video-player.png')); ?>" alt="Video player">
                    ...
                    <div class="col-md-6 multipay-desc">
                        <div>
                            ...
                            <div class="d-flex justify-content-center">
                                <a href="#">
                                    <img src="<?php echo e(asset('img/footer/google-play.svg')); ?>" class="pr-3">
                                </a>
                                <a href="#">
                                    <img src="<?php echo e(asset('img/footer/app-store.svg')); ?>">
                                </a>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Teacher\Desktop\KDBBU\resources\views/individuals/remote-banking/mobile-banking.blade.php ENDPATH**/ ?>