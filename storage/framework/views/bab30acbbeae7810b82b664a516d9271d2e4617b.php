                            ...
                            <div class="item">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8 information">
                                        ...
                                        <a href="<?php echo e($link->source_link); ?>" class="link"><?php echo e($link->source_name); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Teacher\Desktop\KDBBU\resources\views/interactive-services/usefull-links.blade.php ENDPATH**/ ?>