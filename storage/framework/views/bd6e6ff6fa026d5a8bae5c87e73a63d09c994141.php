    ...
    <div class="nav-two-inner flex-justify-between">
            ...
            <div>
                ...
                <div class="gamburger-mega-menu">
                    ...
                    <div class="mega-menu-buttons">
                        <a href="https://ibank.kdb.uz/" class="internet-banking flex-center" target="_blank">internet banking</a>
                    </div>
                    <ul class="row">
                        <div class="col-md-4">
                                    ...
                                    <li class="mega-menu-inner">
                                        ...
                                        <div class="mega-menu-callapse collapse" id="corporates-collapse">
                                            <div class="drop-body card card-body">
                                                <a class="drop-item" href="<?php echo e(route('corporates.crm', app()->getLocale())); ?>">client relatioship management</a>
                                                ...
                                                <a class="drop-item" href="<?php echo e(route('corporates.local-terminals', app()->getLocale())); ?>">acquiring services</a>
                                    ...
                                    <li class="mega-menu-inner">
                                        ...
                                        <div class="mega-menu-callapse collapse" id="individuals-collapse">
                                            <div class="drop-body card card-body">
                                                ...
                                                <a class="drop-item" href="<?php echo e(route('individuals.remote-banking.internet-banking', app()->getLocale())); ?>">digital banking</a>
                                    ...
                                    <li class="mega-menu-inner">
                                        ...
                                        <div class="mega-menu-callapse collapse" id="interactive-service-collapse">
                                            <div class="drop-body card card-body">
                                                ...
                                                <a class="drop-item" href="<?php echo e(route('interactive-services.exchange-rates', app()->getLocale())); ?>">exchange rates</a>
                                                <a class="drop-item" href="<?php echo e(route('interactive-services.calculators', app()->getLocale())); ?>">calculators</a>
                                    ...
                                    <li class="mega-menu-inner">
                                        ...
                                        <div class="mega-menu-callapse collapse" id="press-center-collapse">
                                            <div class="drop-body card card-body">
                                                ...
                                                <a class="drop-item" href="<?php echo e(route('press-center.copy-right', app()->getLocale())); ?>">terms of use & <br/> privacy policy</a>
                                            </div>
                                        </div>
                                    </li>
                                </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="drop-menu">
                        <div class="drop-item-box">
                            <a class="drop-item" href="<?php echo e(route('corporates.crm', app()->getLocale())); ?>">client relationship management</a>
                            <a class="drop-item" href="<?php echo e(route('corporates.account-opening', app()->getLocale())); ?>">account opening & administration</a>
                            <a class="drop-item" href="<?php echo e(route('corporates.payments-and-cash-management', app()->getLocale())); ?>">payments & cash management</a>
                        </div>
                        <div class="drop-item-box">
        ...
        <div class="flex-justify-between align-items-center">
            ...
            <div class="flex-align-center">
                ...
                <a href="https://ibank.kdb.uz/" class="internet-banking" target="_blank">internet banking</a>
            </div>
        </div>
    </div>
</nav>
<!-- Nav two ends<?php /**PATH C:\Users\Teacher\Desktop\KDB Last\resources\views/layouts/nav.blade.php ENDPATH**/ ?>