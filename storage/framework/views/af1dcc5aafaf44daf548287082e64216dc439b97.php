...
<?php $__env->startSection('page-title'); ?>
    <?php echo app('translator')->get('individuals/remote-banking/internet-banking.1'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>

    <span class="small-paragraph"><?php echo app('translator')->get('individuals/remote-banking/internet-banking.2'); ?></span>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('meta'); ?>

    <title><?php echo app('translator')->get('individuals/remote-banking/internet-banking.3'); ?></title>
    ...
    <section class="desctop container internet-banking mt-5">
        <div class="row">
            ...
            <main class="col-xl-9 main-hero mb-5">
                <h2 class="heading-2"><?php echo app('translator')->get('individuals/remote-banking/internet-banking.4'); ?></h2>
                <p class="small-paragraph">
                    <?php echo app('translator')->get('individuals/remote-banking/internet-banking.5'); ?>
                </p>
                <div class="row">
                    <div class="col-md-4">
                        <div class="simple-card text-center">
                            <div>
                                ...
                                <p class="small-paragraph mt-2">
                                    <?php echo app('translator')->get('individuals/remote-banking/internet-banking.6'); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mt-4 mt-md-0">
                        <div class="simple-card text-center">
                            <div>
                                ...
                                <p class="small-paragraph mt-2">
                                    <?php echo app('translator')->get('individuals/remote-banking/internet-banking.7'); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mt-4 mt-md-0">
                        <div class="simple-card text-center">
                            <div>
                                ...
                                <p class="small-paragraph mt-2">
                                    <?php echo app('translator')->get('individuals/remote-banking/internet-banking.8'); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                </div>
                <h2 class="heading-2 mt-5"><?php echo app('translator')->get('individuals/remote-banking/internet-banking.9'); ?></h2>
                <p class="small-paragraph">
                    <?php echo app('translator')->get('individuals/remote-banking/internet-banking.10'); ?>
                </p>
                <p class="small-paragraph">
                    <?php echo app('translator')->get('individuals/remote-banking/internet-banking.11'); ?>
                </p>
                <h3 class="heading-3 my-4"><?php echo app('translator')->get('individuals/remote-banking/internet-banking.12'); ?></h3>
                <ul class="right-icon">
                    <li>
                        <p><?php echo app('translator')->get('individuals/remote-banking/internet-banking.13'); ?></p>
                    </li>
                    <li>
                        <p><?php echo app('translator')->get('individuals/remote-banking/internet-banking.14'); ?></p>
                    </li>
                </ul>
                <div class="email mt-4">
                    <span class="small-paragraph email-card-title">
                        <strong><?php echo app('translator')->get('individuals/remote-banking/internet-banking.15'); ?></strong>
                    </span>
                    <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/u0560543/kdb.itmaker.uz/resources/views/individuals/remote-banking/internet-banking.blade.php ENDPATH**/ ?>