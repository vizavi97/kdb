...
<?php $__env->startSection('page-title'); ?>
    <?php echo app('translator')->get('investors/information-on-gsm.1'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <span class="small-paragraph"><?php echo app('translator')->get('investors/information-on-gsm.2'); ?></span>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('meta'); ?>

    <title><?php echo app('translator')->get('investors/information-on-gsm.3'); ?></title>
                            ...
                            <div class="information-gsm-item">
                                <div class="row">
                                    <div class="col-lg-2 gsm-month">
                                        ...
                                        <p class="fs-12"><?php echo e(date( 'm.Y', strtotime($post->date) )); ?></p>
                                    </div>
                                    <div class="col-lg-6 gsm-holding">
                                        <h3 class="heading-3"><?php echo e($post->getTranslatedAttribute('title', app()->getLocale(), 'fallbackLocale')); ?></h3>
                                        <p class="small-paragraph fs-12"><?php echo e($post->getTranslatedAttribute('excerpt', app()->getLocale(), 'fallbackLocale')); ?></p>
                                    </div>
                                    <div class="col-lg-4 gsm_location">
                                        <div class="gsm-location-item">
                                            <span class="fa fa-map-marker-alt fs-12"></span>
                                            <p class="small-paragraph fs-12"><?php echo e($post->getTranslatedAttribute('address', app()->getLocale(), 'fallbackLocale')); ?></p>
                                        </div>
                                        <div class="gsm-location-item">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/u0560543/kdb.itmaker.uz/resources/views/investors/information-on-gsm.blade.php ENDPATH**/ ?>