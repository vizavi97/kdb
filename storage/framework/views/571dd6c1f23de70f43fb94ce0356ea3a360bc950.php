                        ...
                        <div class="col-lg-6">
                            <div class="item">
                                ...
                                <form action="<?php echo e(route('interactive-services.post-subscription', app()->getLocale())); ?>" method="POST">
                                    ...
                                    <input type="text" name="full_name" id="name" class="email mb-4" placeholder="Your Full Name" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Teacher\Desktop\KDB Last\resources\views/interactive-services/subscription-for-banks-materials.blade.php ENDPATH**/ ?>