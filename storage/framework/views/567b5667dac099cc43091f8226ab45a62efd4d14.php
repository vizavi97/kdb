                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 col-12 mb-4">
                        <a href="<?php echo e(route('corporates.credit.credit-legal-entities', app()->getLocale())); ?>" class="card-link">
                            Loan to Legal Entities
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-12 mb-4">
                        <a href="#" class="card-link">
                            Loans to Employees of Legal Entities
                        </a>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-12 mb-4">
                        <a href="#" class="card-link">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Teacher\Desktop\KDB Last\resources\views/corporates/credit/credit.blade.php ENDPATH**/ ?>