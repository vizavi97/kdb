<?php $__env->startSection('page-title'); ?>
    <?php echo app('translator')->get('corporates/bank-tariffs.1'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
    <span class="small-paragraph"><?php echo app('translator')->get('corporates/bank-tariffs.2'); ?></span>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('meta'); ?>

    <title><?php echo app('translator')->get('corporates/bank-tariffs.3'); ?></title>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="business-plan-box">
                            <div class="bg position-relative">
                                ...
                                <span><?php echo e(date( 'd.m.Y', strtotime($tariff->created_at) )); ?></span>
                            </div>
                            <div class="p-4">
                                <h2 class="heading-3 mb-3"><?php echo e($tariff->getTranslatedAttribute('title', app()->getLocale(), 'fallbackLocale') . ' ' . date( 'd.m.Y', strtotime($tariff->created_at) )); ?></h2>
                                <a href="<?php echo e(Voyager::image( (json_decode($tariff['file_' . app()->getLocale()]))[0]->download_link )); ?>" class="flex-justify-center" download>
                                   ...
                                   <span class="small-paragraph"><?php echo app('translator')->get('corporates/bank-tariffs.4'); ?></span>
                               </a>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DESKTOP\KDB\resources\views/corporates/bank-tariffs.blade.php ENDPATH**/ ?>