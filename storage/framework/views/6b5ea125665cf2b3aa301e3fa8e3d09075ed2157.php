...
<footer class="footer">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 item-1">
                    ...
                    <p class="small-paragraph">
                        The Bank operates under the License of CBU №5 from October 27, 2017.
                    </p>
                    <p class="small-paragraph">
                ...
                <div class="col-lg-2 col-md-6 item-2">
                    ...
                    <a href="https://ek.uz/uz">
                        www.ek.uz
                    </a>
                </div>
                <div class="col-lg-3 col-md-6 item-3 pr-lg-4">
                    <h4 class="heading-4">Mobile App</h4>
                    <p class="paragraph">Multipay, mobile application which will make your life easy without stress!</p>
                    <div class="row m-0">
                ...
                <div class="col-lg-4 col-md-6 item-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-11 pl-3">
                            <strong class="ml-0">Address</strong>
                            <address>
                                3 Bukhara Street, Tashkent 100070 <br/>The Republic of Uzbekistan
                            </address>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-11 pl-3">
                            <strong class="ml-0">Mail Us</strong>
                            <a class="ml-0" href="mailto:info@kdb.uz">info@kdb.uz</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-1">
                        ...
                        <div class="col-11 pl-3">
                            <strong class="ml-0">Phone</strong>
                            <a class="ml-0" href="tel:+998711208000">+998 71 120 80 00</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-image">
        <img src="<?php echo e(asset('img/footer/background.webp')); ?>">
    </div>
</footer>
<!-- Footer Ends --><?php /**PATH /home/uzgenius/domains/uzgenius.uz/public_html/kdb/resources/views/layouts/footer.blade.php ENDPATH**/ ?>