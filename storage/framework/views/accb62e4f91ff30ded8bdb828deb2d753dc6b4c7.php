...
<?php $__env->startSection('content'); ?>
    ...
    <section class="breadcrumb-custom container-fluid single-local-card">
        <div class="desctop container">
            ...
            <div>
                <a class="small-paragraph" href="<?php echo e(route('home', app()->getLocale())); ?>"><?php echo app('translator')->get('single-card.home'); ?></a> /
            ...
            <article class="card-cards mt-5">
                <div class="row m-0">
                    ...
                    <div class="col-lg-8 p-0 pl-lg-5 mt-4 mt-lg-0">
                        <div class="row">
                            <div class="col-md-4">
                                <p class="small-paragraph"><?php echo app('translator')->get('single-card.payment-system'); ?></p>
                            ...
                            <div class="col-md-4 mt-4 mt-md-0">
                                <p class="small-paragraph"><?php echo app('translator')->get('single-card.currency'); ?></p>
                                <p class="small-paragraph fs-14 d-flex align-items-center mb-0">
                            ...
                            <div class="col-md-4 mt-4 mt-md-0">
                                <p class="small-paragraph"><?php echo app('translator')->get('single-card.type-of'); ?></p>
                                <p class="small-paragraph fs-14 d-flex align-items-center mb-0">
        ...
        <div class="row">
            ...
            <main class="col-xl-9 main-hero mb-5">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="desc-tab" data-toggle="tab" href="#desc" role="tab" aria-controls="desc" aria-selected="true"><?php echo app('translator')->get('single-card.description'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="instruction-tab" data-toggle="tab" href="#instruction" role="tab" aria-controls="instruction" aria-selected="false"><?php echo app('translator')->get('single-card.instruction'); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="tariffs-tab" data-toggle="tab" href="#tariffs" role="tab" aria-controls="tariffs" aria-selected="false"><?php echo app('translator')->get('single-card.tariffs'); ?></a>
                    </li>
                </ul>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/u0560543/kdb.itmaker.uz/resources/views/single-card.blade.php ENDPATH**/ ?>