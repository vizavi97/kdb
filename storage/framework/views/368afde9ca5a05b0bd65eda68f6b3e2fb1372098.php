                        ...
                        <div class="row m-0">
                            <div class="col-lg-8 px-0 pr-lg-4">
                                ...
                                <div class="slider mt-3">
                                    <div class="header">
                                        <h5><?php echo app('translator')->get('individuals/credit.26_1'); ?></h5>
                                        <div class="holder">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 px-3 py-4">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-lg-3">
                                                <p class="small-paragraph">
                                                    <strong><?php echo app('translator')->get('individuals/credit.36'); ?></strong>
                                                </p>
                                            </div>
                                            <div class="col-lg-9">
                                        ...
                                        <div class="row mb-4">
                                            <div class="col-lg-3">
                                                <p class="small-paragraph">
                                                    <strong><?php echo app('translator')->get('individuals/credit.38'); ?></strong>
                                                </p>
                                            </div>
                                            <div class="col-lg-9">
                                                <p class="small-paragraph"><?php echo e($branch->getTranslatedAttribute('fax', app()->getLocale(), 'fallbackLocale')); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/u0560543/kdb.itmaker.uz/resources/views/individuals/credit.blade.php ENDPATH**/ ?>