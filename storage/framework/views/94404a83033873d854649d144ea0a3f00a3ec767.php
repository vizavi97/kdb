<aside class="col-xl-3 aside-hero">
    ...
    <ul>
        <li>
            <a href="<?php echo e(Request::is( app()->getLocale() . '/corporates/crm') ? 'javascript:void(0)' : route('corporates.crm', app()->getLocale())); ?>" class="<?php echo e(Request::is( app()->getLocale() . '/corporates/crm') ? 'active' : ''); ?>">CRM</a>
        </li>
        <li>
        ...
        <li>
            <a href="<?php echo e(Request::is( app()->getLocale() . '/corporates/application-for-loan') ? 'javascript:void(0)' : route('corporates.application-for-loan', app()->getLocale())); ?>" class="<?php echo e(Request::is( app()->getLocale() . '/corporates/application-for-loan') ? 'active' : ''); ?>">Application for Loan</a>
        </li>
        <li>
...
</aside><?php /**PATH C:\Users\Uzgenius Academy\Desktop\WEBSITES\KDB\resources\views/layouts/sidebars/corporates-sidebar.blade.php ENDPATH**/ ?>