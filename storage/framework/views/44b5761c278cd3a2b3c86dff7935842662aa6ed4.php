<aside class="col-xl-3 aside-hero">
    ...
    <ul>
        ...
        <li>
            <a href="<?php echo e(Request::is( app()->getLocale() . '/individuals/credit') ? 'javascript:void(0)' : route('individuals.credit', app()->getLocale(), app()->getLocale())); ?>" class="<?php echo e(Request::is( app()->getLocale() . '/individuals/credit') ? 'active' : ''); ?>">Credit</a>
        </li>
        <li>
        ...
        <div class="collapse <?php echo e(Str::contains(Route::currentRouteName(), 'individuals.exchange-office') ? 'show' : ''); ?>" id="exchange-office">
            <li>
                <a class="drop-item <?php echo e(Request::is( app()->getLocale() . '/individuals/exchange-office') ? 'active' : ''); ?>" href="<?php echo e(route('individuals.exchange-office', app()->getLocale())); ?>">exchange office details</a>
            </li>
            <li>
            ...
            <li>
                <a class="drop-item <?php echo e(Request::is( app()->getLocale() . '/individuals/exchange-office/conversion-operations') ? 'active' : ''); ?>" href="<?php echo e(route('individuals.exchange-office.conversion-operations', app()->getLocale())); ?>">Conversion Operations</a>
            </li>
...
</aside><?php /**PATH C:\Users\User 5\Desktop\KDB Last\resources\views/layouts/sidebars/individuals-sidebar.blade.php ENDPATH**/ ?>