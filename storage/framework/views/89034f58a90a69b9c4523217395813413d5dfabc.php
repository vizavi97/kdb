...
<?php $__env->startSection('content'); ?>
    ...
    <section class="desctop container local-cards my-5">
        <div class="row">
                                        ...
                                        <div class="row m-0">
                                            ...
                                            <div class="col-lg-8 p-0 pl-lg-4 mt-4 mt-lg-0">
                                                <div class="d-flex justify-content-between">
                                                    <h3 class="heading-3 mb-0"><?php echo e($card->getTranslatedAttribute('name', $locale, 'fallbackLocale')); ?></h3>
                                                    <p class="mb-0 fs-14 d-none d-md-flex align-items-center">
                                                        <?php echo app('translator')->get('cards.learn-all'); ?>
                                                        <i class="fas fa-angle-right pl-1"></i>
                                                    </p>
                                                </div>
                                                <div class="row mt-4">
                                                    <div class="col-md-4">
                                                        <p class="small-paragraph"><?php echo app('translator')->get('cards.payment-system'); ?></p>
                                                    ...
                                                    <div class="col-md-4 mt-4 mt-md-0">
                                                        <p class="small-paragraph"><?php echo app('translator')->get('cards.currency'); ?></p>
                                                        <p class="small-paragraph fs-14 d-flex align-items-center mb-0">
                                                    ...
                                                    <div class="col-md-4 mt-4 mt-md-0">
                                                        <p class="small-paragraph"><?php echo app('translator')->get('cards.type-of'); ?></p>
                                                        <p class="small-paragraph fs-14 d-flex align-items-center mb-0">
                                                ...
                                                <?php if($card->note): ?>
                                                    <div class="custom-alert mt-4">
                                                        <p class="text"><?php echo e($card->getTranslatedAttribute('note', $locale, 'fallbackLocale')); ?></p>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
            ...
            <?php if($current_route_name == "individuals.local-cards" || $current_route_name == "individuals.international-cards"): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /usr/local/www/apache24/data/resources/views/cards.blade.php ENDPATH**/ ?>