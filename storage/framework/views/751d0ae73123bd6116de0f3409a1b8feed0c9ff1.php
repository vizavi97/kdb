...
<?php $__env->startSection('content'); ?>
    ...
    <section class="best-services">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-4">
                    <a href="<?php echo e(url(app()->getLocale() . '/corporates/application-for-loan')); ?>" class="service-link">
                        <div class="item">
                            <header class="flex-align-center">
    ...
    <section class="container-fluid px-0 counters pt-48 pb-48">
        <div class="container">
            <h2 class="heading-2">Provides Financial Services for 22 Years with Trust</h2>
            <p class="paragraph">
                KDB Bank Uzbekistan provides wide range of banking services. The Bank offers corporate and personal banking, loans, leasing, and e-banking services.
            </p>
            <div class="row pt-48">
            ...
            <div class="row">
                ...
                <div class="col-md-5 pt-5 pt-md-0">
                    ...
                    <div class="item mtb-15">
                        <p class="small-text">
                            <strong>Yunusabad Branch of "KDB Bank Uzbekistan" JSC</strong>
                        </p>
                        <a href="tel:+998711208000" class="small-text mb-1">
                            <strong>Phone:</strong>
                            (+998 71) 120-61-41
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Teacher\Desktop\KDB Last\resources\views/homepage.blade.php ENDPATH**/ ?>