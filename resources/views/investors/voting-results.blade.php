...
@section('page-title')
    @lang('investors/voting-results.1')
@stop

@section('breadcrumb')
    <span class="small-paragraph">@lang('investors/voting-results.2')</span>
@stop

@section('meta')

    <title>@lang('investors/voting-results.3')</title>

    {{-- Custom CSS --}}
    <link rel="stylesheet" type="text/css" href="{{ asset('css/investors/voting-results.css') }}">
    ...
    <section class="desctop container voting-results mt-5">
        <div class="row">
            ...
            <main class="col-xl-9 main-hero mb-5">
                <h2 class="heading-2 mb-4">@lang('investors/voting-results.4')</h2>
