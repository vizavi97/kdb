...
@section('page-title')
    @lang('about-us/banks-charter.bank-charter')
@stop

@section('breadcrumb')
    <span class="small-paragraph">@lang('about-us/banks-charter.bank-charter-2')</span>
@stop

@section('meta')

    <title>@lang('about-us/banks-charter.kdb-bank')</title>
            ...
            <main class="col-xl-9 main-hero mb-5">
                <div class="row">
                    @foreach($tariffs as $tariff)
                        @if(json_decode($tariff['file_' . app()->getLocale()]))
                                ...
                                <div class="business-plan-box">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <a href="{{ Voyager::image( (json_decode($tariff['file_' . app()->getLocale()]))[0]->download_link ) }}" class="flex-justify-center" download>
                                            ...
                                            <span class="small-paragraph">@lang('about-us/banks-charter.download')</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
