...
@section('page-title')
    @lang('corporates/treasury.1')
@stop

@section('breadcrumb')

    <span class="small-paragraph">@lang('corporates/treasury.2')</span>

@stop

@section('meta')

    <title>@lang('corporates/treasury.3')</title>

    {{-- Custom CSS --}}
    <link rel="stylesheet" type="text/css" href="{{ asset('css/corporates/treasury.css') }}">
        ...
        <div class="row">
            ...
            <main class="col-xl-9 main-hero mb-5">
                <div class="first-parent">
                    <h2 class="heading-2">
                        @lang('corporates/treasury.4')
                    </h2>
                    <p class="parahraph">
                        @lang('corporates/treasury.5')
                    </p>
                </div>
                <div class="second-parent">
                    <div class="row box">
                        ...
                        <div class="col-lg-11 col-md-9 col-12">
                            <h3 class="heading-3">
                                @lang('corporates/treasury.6')
                            </h3>
                            <p class="paragraph">
                                @lang('corporates/treasury.7')
                            </p>
                        </div>
                    </div>
                    <div class="row box">
                        ...
                        <div class="col-lg-11 col-md-9 col-12">
                            ...
                            <p class="paragraph mb-4">
                                @lang('corporates/treasury.8')
                            </p>
                            <p class="paragraph">
                                @lang('corporates/treasury.9')
                            </p>
                        </div>
                    </div>
                    <div class="row box">
                        ...
                        <div class="col-lg-11 col-md-9 col-12">
                            <h3 class="heading-3">
                                @lang('corporates/treasury.10')
                            </h3>
                            <p class="paragraph">
                                @lang('corporates/treasury.11')
                            </p>
                        </div>
                    </div>
                </div>
