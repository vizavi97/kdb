...
@section('page-title')
    @lang('corporates/bank-tariffs.1')
@stop

@section('breadcrumb')
    <span class="small-paragraph">@lang('corporates/bank-tariffs.2')</span>
@stop

@section('meta')

    <title>@lang('corporates/bank-tariffs.3')</title>
                        ...
                        <div class="business-plan-box">
                            ...
                            <div class="p-4">
                                ...
                                <a href="{{ Voyager::image( (json_decode($tariff['file_' . app()->getLocale()]))[0]->download_link ) }}" class="flex-justify-center" download>
                                   ...
                                   <span class="small-paragraph">@lang('corporates/bank-tariffs.4')</span>
                               </a>
                            </div>
                        </div>
                    </div>
