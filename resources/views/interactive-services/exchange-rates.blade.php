...
@section('page-title')
    @lang('interactive-services/exchange-rates.1')
@stop

@section('breadcrumb')

    <span class="small-paragraph">@lang('interactive-services/exchange-rates.2')</span>

@stop

@section('meta')

    <title>@lang('interactive-services/exchange-rates.3')</title>
        ...
        <div class="row">
            <main class="col-xl-9 main-hero">
                <div class="row conversion-card">
                    <div class="col-lg-4">
                        <label for="amount">@lang('interactive-services/exchange-rates.4')</label>
                        <input type="text" id="amount" value="100" maxlength="20">
                    </div>
                    <div class="col-lg-4 d-flex justify-content-between align-items-center mt-4 mt-lg-0">
                        <div class="from">
                            <label for="from">@lang('interactive-services/exchange-rates.5')</label>
                            <div id="from-cont">
                                <select id="from">
                        ...
                        <div class="to">
                            <label for="to">@lang('interactive-services/exchange-rates.6')</label>
                            <div id="to-cont">
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0">
                        <label>@lang('interactive-services/exchange-rates.7')</label>
                        <div id="result"></div>
                    </div>
                    <div class="col-12">
                        <p class="mt-4">
                            @lang('interactive-services/exchange-rates.8')
                        </p>
                    </div>
                    <div class="col-12 mt-5">
                        <div class="d-flex flex-wrap justify-content-between align-items-center">
                            <h3>@lang('interactive-services/exchange-rates.9')</h3>
                            <ul class="nav nav-tabs rate-switcher mt-4 mt-lg-0" id="myTab" role="tablist">
                                <li>
                                    <a class="item active" id="kdb-tab" data-toggle="tab" href="#kdb" role="tab" aria-controls="kdb" aria-selected="true">
                                        @lang('interactive-services/exchange-rates.9_1')
                                    </a>
                                </li>
                                <li>
                                    <a class="item" id="cbu-tab" data-toggle="tab" href="#cbu" role="tab" aria-controls="cbu" aria-selected="false">
                                        @lang('interactive-services/exchange-rates.9_2')
                                    </a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <th>
                                                ...
                                                @lang('interactive-services/exchange-rates.10')
                                            </th>
                                            @foreach ($rates as $rate)
                                                <td>
                                                    {{ $rate->buy . ' / ' . $rate->sell }}
                                ...
                                <table class="d-lg-none">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>
                                                <img src="{{ asset('img/individuals/exchange-office/currency-conversion/UZS.svg') }}" class="pr-2">
                                                @lang('interactive-services/exchange-rates.11')
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    ...
                                    <table class="d-none d-lg-block">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th>
                                                    <img src="{{ asset('img/individuals/exchange-office/currency-conversion/UZS.svg') }}" class="pr-2">
                                                    @lang('interactive-services/exchange-rates.12')
                                                </th>
                                                @foreach ( getCbuRates() as $rate )
                                                    <td>
                                                        {{ $rate['Rate'] }}
                                    ...
                                    <table class="d-lg-none">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <img src="{{ asset('img/individuals/exchange-office/currency-conversion/UZS.svg') }}" class="pr-2">
                                                    @lang('interactive-services/exchange-rates.13')
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
