            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 item-1">
                    ...
                    <p class="small-paragraph">
                        @lang('layouts/footer.the-bank')
                    </p>
                    <p class="small-paragraph">
                        @lang('layouts/footer.when-using')
                    </p>
                </div>
                <div class="col-lg-2 col-md-6 item-2">
                    <h4>
                        @lang('layouts/footer.useful-links')
                    </h4>
                ...
                <div class="col-lg-3 col-md-6 item-3 pr-lg-4">
                    <h4>@lang('layouts/footer.mobile-app')</h4>
                    <p class="paragraph">
                        @lang('layouts/footer.multipay-mobile')
                    </p>
                    <div class="row m-0">
                        <div class="col-6 pl-0">
                            <a href="https://play.google.com/store/apps/details?id=uz.xsoft.multipay&hl=ru" target="_blank">
                                <img src="{{ asset('img/footer/google-play.svg') }}" width="100%" height="auto">
                            </a>
                        </div>
                        <div class="col-6 pr-0">
                            <a href="https://apps.apple.com/us/app/multipay-kdb/id1437373777" target="_blank">
                                <img src="{{ asset('img/footer/app-store.svg') }}" width="100%" height="auto">
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 item-4">
                    <h4>@lang('layouts/footer.contact-us')</h4>
                    <div class="row">
                        <div class="col-1">
            ...
            <div class="row extra py-4">
                <div class="col-lg-6">
                    <p class="small-paragraph mb-0">
                        @lang('layouts/footer.copyrights-2019')
                    </p>
                </div>
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="{{ route('press-center.copy-right', app()->getLocale()) }}" class="pr-4">
                        @lang('layouts/footer.terms-of')
                    </a>
		    <a href="http://thefarhod.uz/" target="_blank">
                        @lang('layouts/footer.dev')
                    </a>
                </div>
            </div>
        </div>
