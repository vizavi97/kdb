...
@section('content')
        ...
        <div class="slider-index">
            ...
            <div class="slider__slides">
                @foreach($slides as $slide)
                    <div  class="slide-index @if ($loop->first) s--active @endif @if ($loop->last) s--prev @endif">
                                ...
                                <div class="slider-caption">
                                    <div class="position-relative w-100 h-100">
                                        <div class="slider-caption-inner">
                                            <h1 class="heading-1">{{ $slide->getTranslatedAttribute('title', $locale, 'fallbackLocale') }}</h1>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    @if($slide->cta_text && $slide->cta_link)
                                                        <a href="{{ url( app()->getLocale() . '/' . $slide->cta_link ) }}" class="readmore-button">
                                                            {{ $slide->getTranslatedAttribute('cta_text', $locale, 'fallbackLocale') }}
                                                        </a>
                                                    @endif
                                                </div>
                                                @if(count($slides) > 1)
                                                    <div class="col-md-6 d-none d-md-flex justify-content-end">
                                                        <svg class="slider__control mainPrevBtn" xmlns="//www.w3.org/2000/svg" width="7.41" height="12" viewBox="0 0 7.41 12">
                                                            <path d="M15.41,7.41,14,6,8,12l6,6,1.41-1.41L10.83,12Z" transform="translate(-8 -6)" fill="#fff"></path>
                                                        </svg>
                                                        <svg class="slider__control slider__control--right m--right mainNextBtn" xmlns="//www.w3.org/2000/svg" width="7.41" height="12" viewBox="0 0 7.41 12">
                                                            <path d="M10,6,8.59,7.41,13.17,12,8.59,16.59,10,18l6-6Z" transform="translate(-8.59 -6)" fill="#fff"></path>
                                                        </svg>
                                                    </div>
                                                @endif
                                            </div>
    ...
    <section class="container-fluid px-0 bg-white benifits pt-48 pb-48">
        <div class="container">
            <h2 class="heading-2">@lang('homepage.why-choosing')</h2>
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6 benifits-item">
                    ...
                    <div class="content">
                        ...
                        <div>
                            <h4 class="heading-3 m-0 pl-4">@lang('homepage.business-growth')</h4>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 benifits-item">
                    ...
                    <div class="content">
                        ...
                        <div>
                            <h4 class="heading-3 m-0 pl-4">@lang('homepage.sustainability')</h4>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 benifits-item">
                    ...
                    <div class="content">
                        ...
                        <div>
                            <h4 class="heading-3 m-0 pl-4">@lang('homepage.performance')</h4>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active news-nav-link" id="newsitem-tab" data-toggle="tab" href="#newsitem" role="tab" aria-controls="newsitem" aria-selected="true">
                                @lang('homepage.news')
                                <div class="counter">{{ count($news) }}</div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="announcmentitem-tab" data-toggle="tab" href="#announcmentitem" role="tab" aria-controls="announcmentitem" aria-selected="false">
                                @lang('homepage.announcements')
                                <div class="counter">{{ count($announcements) }}</div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="eventsitem-tab" data-toggle="tab" href="#eventsitem" role="tab" aria-controls="eventsitem" aria-selected="false">
                                @lang('homepage.events')
                                <div class="counter">{{ count($events) }}</div>
                            </a>
                        </li>
                    </ul>
                    <div  class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="newsitem" role="tabpanel" aria-labelledby="newsitem-tab">
                            <div class="owl-carousel {{ (count($news) > 2) ? 'owl-item-3' : 'owl-item-4' }}">
                                @foreach( $news as $new )
                                    <a class="news-item" href="{{ route('press-center.news', app()->getLocale()) . '/' . $new->slug }}">
                                        <div class="news-img">
                                            <img src="{{ Voyager::image( $new->image ) }}" alt="{{ $new->getTranslatedAttribute('title', $locale, 'fallbackLocale') }}">
                                        </div>
                                        <div class="news-data">
                                            <span>{{ date( 'd.m.Y', strtotime($new->created_at) ) }}</span>
                                        </div>
                                        <div class="news-caption">
                                            <h6>{{ $new->getTranslatedAttribute('title', $locale, 'fallbackLocale') }}</h6>
                                            <p class="small-paragraph">{{ $new->getTranslatedAttribute('excerpt', $locale, 'fallbackLocale') }}</p>
                                            <span>@lang('homepage.read-more')</span>
                                        </div>
                                    </a>
                                @endforeach
                            </div>
                        ...
                        <div class="tab-pane fade" id="announcmentitem" role="tabpanel" aria-labelledby="announcmentitem-tab">
                            <div class="owl-carousel {{ (count($announcements) > 2) ? 'owl-item-3' : 'owl-item-4' }}">
                                @foreach( $announcements as $announcement )
                                    <a class="news-item" href="{{ route('press-center.news', app()->getLocale()) . '/' . $announcement->slug }}">
                                        <div class="news-img">
                                            <img src="{{ Voyager::image( $announcement->image ) }}" alt="{{ $announcement->getTranslatedAttribute('title', $locale, 'fallbackLocale') }}">
                                        </div>
                                        <div class="news-data">
                                            <span>{{ date( 'd.m.Y', strtotime($announcement->created_at) ) }}</span>
                                        </div>
                                        <div class="news-caption">
                                            <h6>{{ $announcement->getTranslatedAttribute('title', $locale, 'fallbackLocale') }}</h6>
                                            <p class="small-paragraph">{{ $announcement->getTranslatedAttribute('excerpt', $locale, 'fallbackLocale') }}</p>
                                            <span>@lang('homepage.read-more')</span>
                                        </div>
                                    </a>
                                @endforeach
                        ...
                        <div class="tab-pane fade" id="eventsitem" role="tabpanel" aria-labelledby="eventsitem-tab">
                            <div class="owl-carousel {{ (count($events) > 2) ? 'owl-item-3' : 'owl-item-4' }}">
                                @foreach( $events as $event )
                                    <a class="news-item" href="{{ route('press-center.news', app()->getLocale()) . '/' . $event->slug }}">
                                        <div class="news-img">
                                            <img src="{{ Voyager::image( $event->image ) }}" alt="{{ $event->getTranslatedAttribute('title', $locale, 'fallbackLocale') }}">
                                        </div>
                                        <div class="news-data">
                                            <span>{{ date( 'd.m.Y', strtotime($event->created_at) ) }}</span>
                                        </div>
                                        <div class="news-caption">
                                            <h6>{{ $event->getTranslatedAttribute('title', $locale, 'fallbackLocale') }}</h6>
                                            <p class="small-paragraph">{{ $event->getTranslatedAttribute('excerpt', $locale, 'fallbackLocale') }}</p>
                                            <span>@lang('homepage.read-more')</span>
                                        </div>
                                    </a>
                                @endforeach
    ...
    <section class="best-services">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="heading-2">@lang('homepage.our-best')</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12 mb-4">
                    <a href="{{ url(app()->getLocale() . '/corporates/crm') }}" class="service-link">
                        <div class="item">
                            <header class="flex-align-center">
                                ...
                                <h3 class="heading-3">@lang('homepage.crm')</h3>
                            </header>
                            <p class="small-paragraph">
                                @lang('homepage.customer-relationship')
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 col-12 mb-4">
                    <a href="{{ url(app()->getLocale() . '/corporates/credit/application-for-loan') }}" class="service-link">
                        <div class="item">
                            <header class="flex-align-center">
                                ...
                                <h3 class="heading-3">@lang('homepage.loan')</h3>
                            </header>
                            <p class="small-paragraph">
                                @lang('homepage.a-new')
                            </p>
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-4">
                    <a href="{{ url(app()->getLocale() . '/corporates/trade-finance') }}" class="service-link">
                        <div class="item">
                            <header class="flex-align-center">
                                ...
                                <h3 class="heading-3">
                                    @lang('homepage.trade-finance')
                                </h3>
                            </header>
                            <p class="small-paragraph">
                                @lang('homepage.opportunities-for')
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                    <a href="{{ url(app()->getLocale() . '/corporates/international-cards') }}" class="service-link">
                        <div class="item">
                            <header class="flex-align-center">
                                ...
                                <h3 class="heading-3">
                                    @lang('homepage.international-card')
                                </h3>
                            </header>
                            <p class="small-paragraph">
                                @lang('homepage.professional-solution')
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                    <a href="{{ url(app()->getLocale() . '/corporates/treasury') }}" class="service-link">
                        <div class="item">
                            <header class="flex-align-center">
                                ...
                                <h3 class="heading-3">
                                    @lang('homepage.treasury')
                                </h3>
                            </header>
                            <p class="small-paragraph">
                                @lang('homepage.a-new-concept')
                            </p>
                        </div>
                    </a>
                </div>
                <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                    <a href="{{ url(app()->getLocale() . '/corporates/payments-and-cash-management') }}" class="service-link">
                        <div class="item">
                            <header class="flex-align-center">
                                ...
                                <h3 class="heading-3">
                                    @lang('homepage.cash-payment')
                                </h3>
                            </header>
                            <p class="small-paragraph">
                                @lang('homepage.no-stress')
                            </p>
                        </div>
                    </a>
                </div>
        ...
        <div class="container">
            <div class="row p-0">
                <div class="col-xl-6 left">
                    <div>
                        <h2 class="heading-2">@lang('homepage.kdb-mobile')</h2>
                        <p class="small-paragraph">
                            @lang('homepage.customers-enjoy')
                        </p>
                        <div class="app">
                            <a href="https://play.google.com/store/apps/details?id=uz.xsoft.multipay&hl=ru" target="_blank">
                                <img src="{{ asset('img/footer/google-play.svg') }}" class="app-link">
                            </a>
                ...
                <div class="col-xl-6 multipay-image">
                    <a class="fancybox" data-fancybox href="{{ asset('video/multipay-' . app()->getLocale() . '.mp4') }}">
                        <img src="{{ asset('img/home/multipay/multipay-mobile.gif') }}" alt="multipay app">
                    </a>
                </div>
            </div>
        </div>
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active news-nav-link" id="visaitem-tab" data-toggle="tab" href="#visaitem" role="tab" aria-controls="visaitem" aria-selected="true">
                                @lang('homepage.visa')
                                <div class="counter">{{ count($visas) }}</div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="mastercarditem-tab" data-toggle="tab" href="#mastercarditem" role="tab" aria-controls="mastercarditem" aria-selected="false">
                                @lang('homepage.mastercard')
                                <div class="counter">{{ count($masters) }}</div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="uzcarditem-tab" data-toggle="tab" href="#uzcarditem" role="tab" aria-controls="uzcarditem" aria-selected="false">
                                @lang('homepage.uzcard')
                                <div class="counter">{{ count($uzcards) }}</div>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="humoitem-tab" data-toggle="tab" href="#humoitem" role="tab" aria-controls="humoitem" aria-selected="false">
                                @lang('homepage.humo')
                                <div class="counter">{{ count($humos) }}</div>
                            </a>
                        </li>
                    </ul>
                    <div  class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="visaitem" role="tabpanel" aria-labelledby="visaitem-tab">
                            <div class="owl-carousel {{ (count($visas) > 2) ? 'owl-item-3' : 'owl-item-4' }}">
                                @foreach($visas as $visa)
                                    <a class="item" href="{{ url( '/' . app()->getLocale() . '/' . strtolower($visa->ownership) . '/' . strtolower($visa->validity_area) . '-cards/' . $visa->slug ) }}">
                                        <div class="visa-item">
                                            <img src="{{ Voyager::image( $visa->image ) }}" alt="{{ $visa->getTranslatedAttribute('name', $locale, 'fallbackLocale') }}">
                                            <div class="visa-caption">
                                                <h6>{{ $visa->getTranslatedAttribute('name', $locale, 'fallbackLocale') }}</h6>
                                                <p class="small-paragraph">{{ $visa->getTranslatedAttribute('excerpt', $locale, 'fallbackLocale') }}</p>
                                                <span>@lang('homepage.read-more-cards')</span>
                                            </div>
                                        </div>
                                    </a>
                                @endforeach
                        ...
                        <div class="tab-pane fade" id="mastercarditem" role="tabpanel" aria-labelledby="mastercarditem-tab">
                            <div class="owl-carousel {{ (count($masters) > 2) ? 'owl-item-3' : 'owl-item-4' }}">
                                @foreach($masters as $master)
                                    <a class="item" href="{{ url( '/' . app()->getLocale() . '/' . strtolower($master->ownership) . '/' . strtolower($master->validity_area) . '-cards/' . $master->slug ) }}">
                                        <div class="visa-item">
                                            <img src="{{ Voyager::image( $master->image ) }}" alt="{{ $master->getTranslatedAttribute('name', $locale, 'fallbackLocale') }}">
                                            <div class="visa-caption">
                                                <h6>{{ $master->getTranslatedAttribute('name', $locale, 'fallbackLocale') }}</h6>
                                                <p class="small-paragraph">{{ $master->getTranslatedAttribute('excerpt', $locale, 'fallbackLocale') }}</p>
                                                <span>@lang('homepage.read-more-cards')</span>
                                            </div>
                                        </div>
                                    </a>
                        ...
                        <div class="tab-pane fade" id="uzcarditem" role="tabpanel" aria-labelledby="uzcarditem-tab">
                            <div class="owl-carousel {{ (count($uzcards) > 2) ? 'owl-item-3' : 'owl-item-4' }}">
                                @foreach($uzcards as $uzcard)
                                    <a class="item" href="{{ url( '/' . app()->getLocale() . '/' . strtolower($uzcard->ownership) . '/' . strtolower($uzcard->validity_area) . '-cards/' . $uzcard->slug ) }}">
                                        <div class="visa-item">
                                            <img src="{{ Voyager::image( $uzcard->image ) }}" alt="{{ $uzcard->getTranslatedAttribute('name', $locale, 'fallbackLocale') }}">
                                            <div class="visa-caption">
                                                <h6>{{ $uzcard->getTranslatedAttribute('name', $locale, 'fallbackLocale') }}</h6>
                                                <p class="small-paragraph">{{ $uzcard->getTranslatedAttribute('excerpt', $locale, 'fallbackLocale') }}</p>
                                                <span>@lang('homepage.read-more-cards')</span>
                                            </div>
                                        </div>
                                    </a>
                        ...
                        <div class="tab-pane fade" id="humoitem" role="tabpanel" aria-labelledby="humoitem-tab">
                            <div class="owl-carousel owl-theme {{ (count($humos) > 2) ? 'owl-item-3' : 'owl-item-4' }}">
                                @foreach($humos as $humo)
                                    <a class="item" href="{{ url( '/' . app()->getLocale() . '/' . strtolower($humo->ownership) . '/' . strtolower($humo->validity_area) . '-cards/' . $humo->slug ) }}">
                                        <div class="visa-item">
                                            <img src="{{ Voyager::image( $humo->image ) }}" alt="{{ $humo->getTranslatedAttribute('name', $locale, 'fallbackLocale') }}">
                                            <div class="visa-caption">
                                                <h6>{{ $humo->getTranslatedAttribute('name', $locale, 'fallbackLocale') }}</h6>
                                                <p class="small-paragraph">{{ $humo->getTranslatedAttribute('excerpt', $locale, 'fallbackLocale') }}</p>
                                                <span>@lang('homepage.read-more-cards')</span>
                                            </div>
                                        </div>
                                    </a>
    ...
    <section class="container-fluid px-0 counters pt-48 pb-48">
        <div class="container">
            <h2 class="heading-2">@lang('homepage.provides-financial')</h2>
            <p class="paragraph">
                @lang('homepage.kdb-bank-uzbekistan')
            </p>
            <div class="row pt-48">
                <div class="col-md-3 col-sm-6 counter-item mb-5 mb-md-5 mb-lg-0">
                    <span class="counter-value" data-count="18">0</span>
                    <span>@lang('homepage.global-subsiders')</span>
                </div>
                <div class="col-md-3 col-sm-6 counter-item mb-5 mb-md-5 mb-lg-0">
                    <span class="counter-value" data-count="3">0</span>
                    <span>@lang('homepage.local-branches')</span>
                </div>
        ...
        <div class="row mx-0">
            <div class="consultation-left flex-align-center col-lg-6">
                ...
                <div class="consultation-caption">
                    <h2 class="heading-2">@lang('homepage.get-a-free')</h2>
                    <p class="small-paragraph">
                        @lang('homepage.fill-out')
                        <ul>
                            <li>@lang('homepage.review-your')</li>
                            <li>@lang('homepage.talk-about')</li>
                            <li>@lang('homepage.discuss-the')</li>
                        </ul>
                    </p>
                </div>
            </div>
            <div class="consultation-right col-lg-6 py-5 py-lg-0">
                <form action="{{ route('home.post-consultation', app()->getLocale()) }}" method="POST">
                    @csrf
                    <div class="row mx-0">
                        <div class="col-12">
                            <h4 class="heading-3">@lang('homepage.i-would')</h4>
                            <select name="topic" required>
                                <option value="Account Opening">@lang('homepage.account-opening')</option>
                                <option value="Business Growth">@lang('homepage.business-growth-2')</option>
                                <option value="Cash Withdrawing">@lang('homepage.cash-withdrawing')</option>
                                <option value="Trade Finance">@lang('homepage.trade-finance-2')</option>
                                <option value="Loan">@lang('homepage.loan-2')</option>
                                <option value="Other">@lang('homepage.other')</option>
                            </select>
                        </div>
                    </div>
                    <div class="row mx-0">
                        <div class="col-sm-6 pr-sm-2">
                            <input type="text" name="full_name" placeholder="@lang('homepage.full-name')" required>
                        </div>
                        <div class="col-sm-6 pl-sm-2">
                            <input type="email" name="email" placeholder="@lang('homepage.email')" required>
                        </div>
                    </div>
                    <div class="row mx-0">
                        <div class="col-sm-6 pr-sm-2">
                            <input type="text" name="company" placeholder="@lang('homepage.company')" required>
                        </div>
                        <div class="col-sm-6 pl-sm-2">
                            <input type="text" name="phone" placeholder="@lang('homepage.phone')" required>
                        </div>
                    </div>
                    <div class="row mx-0">
                        <div class="col-12">
                            <textarea name="message" placeholder="@lang('homepage.message')" required></textarea>
                            <button type="submit">@lang('homepage.send')</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <section class="branches">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h3>@lang('homepage.branches-in')</h3>
                ...
                <div class="col-md-5 pt-5 pt-md-0">
                    <h3>
                        @lang('homepage.branches-in-location')
                    </h3>
                    <div class="item">
                        <p class="small-text">
                            <strong>@lang('homepage.head-office')</strong>
                        </p>
                        <a href="@lang('homepage.tel:+998')" class="small-text mb-1">
                            <strong>@lang('homepage.phone-2')</strong>
                            @lang('homepage.+998')
                        </a>
                        <p class="small-text mb-1">
                            <strong>@lang('homepage.working-hours') </strong>
                            @lang('homepage.monday-friday')
                        </p>
                        <p class="small-text mb-1">
                            <strong>@lang('homepage.address')</strong>
                            @lang('homepage.3-bukhara')
                        </p>
                    </div>
                    <div class="item mtb-15">
                        <p class="small-text">
                            <strong>@lang('homepage.yunusabad-branch')</strong>
                        </p>
                        <a href="@lang('homepage.tel:+9987')" class="small-text mb-1">
                            <strong>@lang('homepage.phone-3')</strong>
                            @lang('homepage.+9987')
                        </a>
                        <p class="small-text mb-1">
                            <strong>@lang('homepage.working-hours-2') </strong>
                            @lang('homepage.monday-friday-2')
                        </p>
                        <p class="small-text  mb-1">
                            <strong>@lang('homepage.address-2')</strong>
                            @lang('homepage.77-minor')
                        </p>
                    </div>
                    <div class="item">
                        <p class="small-text">
                            <strong>@lang('homepage.yakkasaroy-branch')</strong>
                        </p>
                        <a href="@lang('homepage.tel:+99878')" class="small-text mb-1">
                            <strong>@lang('homepage.phone-4')</strong>
                            @lang('homepage.+99878')
                        </a>
                        <p class="small-text mb-1">
                            <strong>@lang('homepage.working-hours-3') </strong>
                            @lang('homepage.monday-friday-3')
                        </p>
                        <p class="small-text mb-1">
                            <strong>@lang('homepage.address-3')</strong>
                            @lang('homepage.12-usmon')
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="global-modal-content">
                    ...
                    <div class="modal-content-inner">
                        <p class="small-paragraph mb-0">
                            @lang('homepage.sorov-muvaffaqiyatli')
                        </p>
                    </div>
                </div>
            </div>
